...
describe('MathProofAssistant Page', () => {
  ...
  it('shows the assistant setup form if configured', () => {
    ...
    expect(screen.getByLabelText(/Mathematical Claim or Problem:/i)).toBeInTheDocument()
    expect(screen.getByRole('button', { name: /Assist with Proof/i })).toBeInTheDocument()
  })
})
