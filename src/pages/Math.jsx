...
const Math = () => {
  ...
  // Enable MC option buttons to behave like radio buttons
  useEffect(() => {
...
Crucially, include the correct answer AND a brief explanation of the solution within a hidden div: <div class="solution" style="display:none;">Correct Answer: C Explanation: ...</div>. This is vital for checking answers.
...
Return JSON as instructed.`;
    ...
    if (gradableCount > 0) {
        ...
        if (wrongQuestions.length > 0) summaryDiv.innerHTML += `<p>Incorrect questions: ${wrongQuestions.join(', ')}</p>`;
    } else {
            ...
            <form id="exercise-form" onSubmit={handleFormSubmit}>
              ...
              <div>
                ...
                <div className="checkbox-group">
                  ...
                  <label><input type="checkbox" value="ai-judger" checked={exerciseType.includes('ai-judger')} onChange={() => toggleExerciseType('ai-judger')} /> AI Judger (Explanations)</label>
                </div>
              </div>
